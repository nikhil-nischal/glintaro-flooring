...
function App() {
  ...
  const challenges = [
    {
      ...
      description: "Your business has plateaued and you can't seem to break through to the next level of growth."
    },
    {
      icon: <ShoppingCart className="w-8 h-8 text-red-500" />,
      title: "Only Attracting Price Shoppers",
      description: "You're constantly competing on price instead of value, eroding your profit margins."
    },
    {
      icon: <AlertTriangle className="w-8 h-8 text-red-500" />,
      title: "Low-Quality Leads from Lead Platforms",
      description: "You're paying for leads that waste your time and rarely convert into profitable jobs."
    },
    {
      icon: <Flame className="w-8 h-8 text-red-500" />,
      title: "Burnt by Cheap Marketing Agencies",
      description: "You've been disappointed by agencies that overpromise and underdeliver on results."
    }
  ]
  ...
  const glintaroPartnership = [
    {
      ...
      description: "Our exclusive AI Market Dominator system—trusted by less than 3% of companies—combines advanced technology and human insight to deliver top-quality flooring job opportunities straight to you."
    },
    {
      icon: <Zap className="w-8 h-8 text-green-500" />,
      title: "Zero Effort, Maximum Results",
      description: "We handle everything from outreach to qualification and trust-building, so you can focus on your craft and closing jobs."
    },
    {
      icon: <UserCheck className="w-8 h-8 text-green-500" />,
      title: "Advanced Qualification—AI Meets Human Insight",
      description: "Every opportunity is double-checked by AI and experienced humans, ensuring you only meet serious, ready-to-hire homeowners."
    },
    {
      icon: <Handshake className="w-8 h-8 text-green-500" />,
      title: "Seamless Handoff & Close",
      description: "Receive pre-qualified, high-intent job opportunities. You quote and close—simple, efficient, and profitable."
    }
  ]
  ...
  const whatContractorsWant = [
    {
      ...
      description: "A steady pipeline of serious, ready-to-act clients—not just tire-kickers or price shoppers. Fill your calendar with profitable flooring every month."
    },
    {
      icon: <CheckCircle className="w-8 h-8 text-green-500" />,
      title: "Transparency and Trust",
      description: "Clear, honest communication about costs, expectations, and project scope, with no hidden fees or surprises. Our performance-based model ensures alignment."
    },
    {
      icon: <Star className="w-8 h-8 text-green-500" />,
      title: "Reputation and Local Dominance",
      description: "Tools and support to build a strong reputation, collect positive reviews, and stand out as the go-to expert in your local market."
    },
    {
      icon: <Clock className="w-8 h-8 text-green-500" />,
      title: "No Time Wasted",
      description: "Only connect with homeowners who are genuinely interested and qualified, so you can maximize your time and profits, focusing on what you do best."
    },
    {
      icon: <Handshake className="w-8 h-8 text-green-500" />,
      title: "Support and True Partnership",
      description: "A partner who is invested in your success, understands the flooring industry, and shares the risk, working alongside you to achieve your growth goals."
    }
  ]
  ...
  const whatSetsUsApart = [
    ...
    },
    {
      ...
      description: "Track every opportunity and result, so you always know your ROI."
    },
    {
      icon: <Award className="w-8 h-8 text-green-500" />,
      title: "Industry Expertise",
      description: "We specialize exclusively in flooring contractors, understanding your unique challenges and opportunities."
    }
  ]
  ...
  const whoWePartnerWith = [
    ...
    },
    {
      ...
      description: "Are committed to delivering quality work and growing your business"
    }
  ]
  ...
  const faqs = [
    {
      ...
      answer: "Our fees are exclusively tied to your success. You only pay when you close a job from a lead we provide."
    },
    {
      question: "What types of flooring projects do you specialize in?",
      answer: "We can target a wide range of flooring projects, including hardwood, laminate, tile, carpet, and luxury vinyl—tailored to your expertise."
    },
    {
      question: "How quickly can I expect to see results?",
      answer: "Most of our partners begin receiving qualified job opportunities within a few weeks of launching our partnership."
    },
    {
      question: "What if a lead doesn't convert?",
      answer: "Our performance-based model means there's no financial risk for unconverted leads. We are committed to delivering only the highest quality opportunities."
    }
  ]
      ...
      <footer className="py-8 px-4 border-t border-gray-800">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col items-center space-y-2 text-gray-400">
            ...
            <p>539 W. Commerce St #6661 Dallas TX 75208 United States</p>
          </div>
        </div>
      </footer>
    </div>
